    ...
    var $ = require("./zepto"),
        ...
        GlobalAudio = function($item) {
            ...
            this._$globalAudio.append(this._$tip),
                ...
                this.audio.autoplay && (this.audio.pause(), $(window).on("load",
                function() {
                    theClass.play()
                })),
                $(window).on("load",
                ...
                this._$globalAudio.on($.isPC ? "click": "tap",
                    function(e) {
                        e.preventDefault(),
                            theClass.isAllowManually && (theClass._$globalAudio.is(".z-play") ? theClass.pause() : theClass.play())
                    }),
